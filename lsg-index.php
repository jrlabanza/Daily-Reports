...
<div style="padding-top: 60px;">
          ...
          <div class="card mb-3">
              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"><canvas id="ChartTester_LSG" width="100%" height="30" style="margin-top:20px;"></canvas></div>
                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab"><canvas id="ChartMachine_LSG" width="100%" height="30" style="margin-top:20px;"></div>
                <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab"><canvas id="ChartWho_LSG" width="100%" height="30" style="margin-top:20px;"></div>
              </div>
 ...
 <div class="card" style="margin-left:10px; margin-right:10px;">
    <div class="card-header" style="font-size:15px;">LSG REPAIR REPORTS
...
if (empty($_POST['startDate'])  && empty($_POST['endDate'])){     
    ...
    $showallrec_query ="SELECT * from lsg_reports WHERE isDeleted = 0 ORDER BY dr_date DESC";
    ...
    $newquery ="SELECT * FROM lsg_reports WHERE DATE(dr_date) BETWEEN '$startDate' and '$endDate' order by dr_date DESC";
    $result = mysqli_query($connection, $newquery);  
}

                         
                 while ($row = mysqli_fetch_array($result)){
                  $attquery ="SELECT COUNT(*) AS attachment_count FROM lsg_uploads WHERE itemId =". $row["id"] ;
                  $attresult = $connection->query($attquery); 
                  $attachmentnumber = get_data_array($attresult);
                        $ddate = $row["dr_date"];
                    ...
                    <tr>
                      ...
                      <?php 
                        ...
                        echo "<td style='text-align: center;'><a id='download-button' data-get-document='".$row['id']."' style='font-size:14px; color:blue; cursor:pointer'>".$attachmentnumber['attachment_count']."</a></td>";
