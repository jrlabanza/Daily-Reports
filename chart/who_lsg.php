...
$sql ="SELECT submitter, COUNT(submitter) As countWho FROM  lsg_reports WHERE isDeleted=0 AND dr_date >= '2019-01-01 00:00:00' GROUP BY submitter ORDER BY countWho DESC";
