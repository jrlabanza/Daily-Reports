...
$sql ="SELECT platform, COUNT(platform) As countPlatform FROM  tester_defective_reports WHERE isDeleted=0 AND date >= '2019-01-01 00:00:00' GROUP BY platform ORDER BY countPlatform DESC LIMIT 10";
