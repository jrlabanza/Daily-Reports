...
$sql ="SELECT tester, COUNT(tester) As countTester FROM  lsg_reports WHERE isDeleted=0 AND dr_date >= '2019-01-01 00:00:00' GROUP BY tester ORDER BY countTester DESC LIMIT 10";
