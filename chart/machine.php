...
$sql ="SELECT fam_name, COUNT(fam_name) As countFam FROM  ftdr.dailyreports WHERE isDeleted=0 AND dr_date >= '2019-01-01 00:00:00' GROUP BY fam_name ORDER BY countFam DESC LIMIT 10";
