...
<div style="padding-top: 60px;">
  <div class="card mb-3">
      ...
      <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"><canvas id="ChartPlatformTesterDefective" width="100%" height="30" style="margin-top:20px;"></canvas></div>
      </div>
        
      </div>
  </div>
 <div class="card" style="margin-left:10px; margin-right:10px;">
    <div class="card-header" style="font-size:15px;">TESTER DEFECTIVE
      ...
      <div class="card-body">
        <table class="record table-bordered table-hover">
          ...
          if (empty($_POST['startDate'])  && empty($_POST['endDate'])){     
              ...
              $showallrec_query ="SELECT * from tester_defective_reports WHERE isDeleted = 0 ORDER BY date DESC";
              ...
              $newquery ="SELECT * FROM tester_defective_reports WHERE DATE(date) BETWEEN '$startDate' and '$endDate' order by date DESC";
