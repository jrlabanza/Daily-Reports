...
<div style="padding-top: 60px;">
  <div class="card mb-3">
      ...
      <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"><canvas id="ChartPlatformTesterTesterPreventiveMaintenance" width="100%" height="30" style="margin-top:20px;"></canvas></div>
      </div>
        
      </div>
  </div>
 <div class="card" style="margin-left:10px; margin-right:10px;">
    <div class="card-header" style="font-size:15px;">TESTER PREVENTIVE MAINTENANCE
    ...
    <div class="card-body">
        <table class="record table-bordered table-hover">
          ...
          if (empty($_POST['startDate'])  && empty($_POST['endDate'])){     
              ...
              $showallrec_query ="SELECT * from tester_preventive_maintenance_reports WHERE isDeleted = 0 ORDER BY date DESC";
              ...
              $newquery ="SELECT * FROM tester_preventive_maintenance_reports WHERE DATE(date) BETWEEN '$startDate' and '$endDate' order by date DESC";
          ...
          while ($row = mysqli_fetch_array($result)){
              ...
              <tr>
                ...
                <td><?php echo $row["pm_findings"] ?> </td>
                <td><?php echo $row["action_d"] ?> </td>
                <td><?php echo $row["pre_vac"] ?> </td>
                <td><?php echo $row["remain_defective_parts"] ?> </td>
