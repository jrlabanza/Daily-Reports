...
<div style="padding-top: 60px;">
  <div class="card mb-3">
      ...
      <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"><canvas id="ChartPlatformTesterRepairReport" width="100%" height="30" style="margin-top:20px;"></canvas></div>
      </div>
 ...
 <div class="card" style="margin-left:10px; margin-right:10px;">
    <div class="card-header" style="font-size:15px;">TESTER REPAIR REPORTS
      ...
      <div class="card-body">
        <table class="record table-bordered table-hover">
          ...
          if (empty($_POST['startDate'])  && empty($_POST['endDate'])){     
              ...
              $showallrec_query ="SELECT * from tester_repair_reports WHERE isDeleted = 0 ORDER BY date DESC";
              ...
              $newquery ="SELECT * FROM tester_repair_reports WHERE DATE(date) BETWEEN '$startDate' and '$endDate' order by date DESC";
